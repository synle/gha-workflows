...
echo """
# dev.sh #####################################################################
curl -fsSL "https://github.com/synle/gha-workflows/blob/head/dev.sh?raw=1" | bash
curl -fsSL "https://github.com/synle/gha-workflows/blob/head/dev.sh?raw=1" | bash -s -- '*.json *.scss *.jsx *.js' 'npm run start' '100'
==============================================================================
