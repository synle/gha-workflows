...
curl -fsSL "https://github.com/synle/gha-workflows/blob/head/format.sh?raw=1" | bash -s -- "npm run format"
=======================================================================================================================
...
source <(curl -fsSL "https://github.com/synle/bashrc/blob/head/.build/format.sh?raw=1")
